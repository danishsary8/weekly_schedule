    ...
    <div className="overflow-hidden rounded-[28px] bg-paper p-3 shadow-[0_28px_70px_-30px_rgba(26,26,26,.45)] ring-1 ring-black/10 sm:p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[.82fr_1.18fr]">
        ...
        <div className="space-y-2.5">
          <div className="relative overflow-hidden rounded-[20px] bg-ink p-4 text-white shadow-[0_0_0_2px_rgba(15,118,110,.75),0_16px_30px_-18px_rgba(15,118,110,.9)]"><span className="absolute inset-y-0 left-0 w-1.5 bg-career" /><div className="flex items-center justify-between gap-2"><span className="font-sans text-label font-bold uppercase tracking-[.14em] text-white/65">9:00 AM – 11:00 AM</span><span className="flex items-center gap-1 rounded-full bg-career px-2 py-0.5 font-sans text-label font-bold uppercase"><span className="h-1.5 w-1.5 rounded-full bg-white" /> Now</span></div><p className="mt-2 font-sans text-sm font-bold sm:text-base">Focused project work</p><div className="mt-3 h-1.5 overflow-hidden rounded-full bg-white/15"><div className="h-full w-[58%] rounded-full bg-career" /></div></div>
          <div className="relative overflow-hidden rounded-[18px] bg-white p-3.5 ring-1 ring-black/[.08]"><span className="absolute inset-y-0 left-0 w-1 bg-faith" /><span className="font-sans text-label font-bold uppercase tracking-[.13em] text-ink/45">11:00 AM – 12:00 PM · Next</span><p className="mt-1 font-sans text-xs font-bold">Lunch and reset</p></div>
          <div className="relative overflow-hidden rounded-[18px] bg-taupe p-3.5"><span className="absolute inset-y-0 left-0 w-1 bg-rest" /><span className="font-sans text-label font-bold uppercase tracking-[.13em] text-ink/55">1:00 PM – 2:00 PM</span><p className="mt-1 font-sans text-xs font-bold">Learn something useful</p></div>
        </div>
      </div>
    </div>
  </div>
